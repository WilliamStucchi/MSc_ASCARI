...
final_yaw_NN_3 = np.zeros(len(step_steering))
...
final_vx_NN_3 = np.zeros(len(step_steering))
...
final_vy_NN_3 = np.zeros(len(step_steering))
...
for speed in speeds:
    for idx, value in enumerate(step_steering):
        ...
        time_values = np.linspace(0, len(vx_result_NN) / 100, len(vx_result_NN))
        plt.plot(time_values, vy_result_NN, label=name_NN, color=color_dict['Red_pastel'], linewidth=2.5)
        """plt.plot(time_values, vy_result_NN_2, label=name_NN_2, color=color_dict['Saffron_pastel'], linewidth=2.5)
        plt.plot(time_values, vy_result_NN_3, label=name_NN_3, color=color_dict['Green_pastel'], linewidth=2.5)"""
        plt.plot(time_values, vy_result_bicycle, label=name_bike, color=color_dict['Saffron_pastel'], linewidth=2.5)
        plt.plot(time_values, vy_result_bicycle_vx_comp, label=name_bike_vx_comp, color=color_dict['Green_pastel'],
                 linestyle='dashed', linewidth=2.5)
        plt.plot(time_values, vy_label, label='Ground Truth', color=color_dict['Blue_pastel'], linestyle='dashed', linewidth=2.5)
        ...
        ax1.plot(time_values, yaw_result_NN[:2000], color=color_dict['Red_pastel'], label=name_NN, linewidth=2.5)
        """ax1.plot(time_values, yaw_result_NN_2[:2000], color=color_dict['Saffron_pastel'], label=name_NN_2, linewidth=2.5)
        ax1.plot(time_values, yaw_result_NN_3[:2000], color=color_dict['Green_pastel'], label=name_NN_3, linewidth=2.5)"""
        ax1.plot(time_values, yaw_result_bicycle[:2000], color=color_dict['Saffron_pastel'], label=name_bike, linewidth=2.5)
        ax1.plot(time_values, yaw_result_bicycle_vx_comp[:2000], color=color_dict['Green_pastel'], label=name_bike_vx_comp,
                 linestyle='dashed', linewidth=2.5)
        ax1.plot(time_values, yaw_label[:2000], color=color_dict['Blue_pastel'], label='Ground Truth', linestyle='dashed', linewidth=2.5)
        ...
        ax2.plot(time_values, steer_quantity_NN[:2000], color=color_dict['Purple_pastel'], label='Steering Input', linewidth=2.5)
        ...
        final_yaw_NN_3[idx] = results_NN_3[-1, 0]
        ...
        final_vx_NN_3[idx] = results_NN_3[2000, 2]
        ...
        final_vy_NN_3[idx] = results_NN_3[2000, 2]
    ...
    plt.plot(gradi, final_yaw_labels, label='Ground Truth', marker='o', linestyle='None', color=color_dict['Blue_pastel'], markersize=20, linewidth=1.5)
    plt.plot(gradi, final_yaw_bicycle, label=name_bike, marker='v', linestyle='None', color=color_dict['Saffron_pastel'], markersize=15, markeredgewidth=2.0, linewidth=1.5)
    plt.plot(gradi, final_yaw_bicycle_vx_comp, label=name_bike_vx_comp, marker='+', markersize=15, markeredgewidth=2.0, linestyle='None',
             color=color_dict['Green_pastel'], linewidth=1.5)
    plt.plot(gradi, final_yaw_NN, label=name_NN, marker='*', linestyle='None', color=color_dict['Red_pastel'], markersize=20, markeredgewidth=2.0, linewidth=1.5)
    # plt.plot(gradi, final_yaw_NN_2, label=name_NN_2, marker='x', linestyle='None', color=color_dict['Saffron_pastel'], markersize=15, markeredgewidth=2.0, linewidth=1.5)
    # plt.plot(gradi, final_yaw_NN_3, label=name_NN_3, marker='+', linestyle='None', color=color_dict['Green_pastel'], markersize=15, markeredgewidth=2.0, linewidth=1.5)
    ...
    plt.ylabel('Yaw rate [rad/s]', labelpad=15)
    plt.xlabel('Steering [deg]', labelpad=15)
    plt.title('Relation between steering and Yaw Rate at ' + vel, fontsize=35)
    plt.legend(loc='best')
    plt.tight_layout()
    ...
    if 'highspeed' in speed:
        plt.savefig(savepath + '/step_steering'
                    '/steer_yaw_fx100_relation.' + save_format, format=save_format, dpi=300)
    elif 'lowspeed' in speed:
        plt.savefig(savepath + '/step_steering'
                    '/steer_yaw_fx25_relation.' + save_format, format=save_format, dpi=300)
    plt.close()
    ...
    plt.plot(gradi, final_yaw_labels / final_vx_labels, label='Ground Truth', marker='o', linestyle='None', color=color_dict['Blue_pastel'],
             markersize=15, markeredgewidth=2.0, linewidth=1.5)
    plt.plot(gradi, final_yaw_bicycle / final_vx_bicycle, label=name_bike, marker='v', linestyle='None', color=color_dict['Saffron_pastel'],
             markersize=15, markeredgewidth=2.0, linewidth=1.5)
    plt.plot(gradi, final_yaw_bicycle_vx_comp / final_vx_bicycle_vx_comp, label=name_bike_vx_comp,
             marker='+', linestyle='None', color=color_dict['Green_pastel'], markersize=15, markeredgewidth=2.5, linewidth=1.5)
    plt.plot(gradi, final_yaw_NN / final_vx_NN, label=name_NN, marker='*', linestyle='None',
             color=color_dict['Red_pastel'], markersize=15, markeredgewidth=2.0, linewidth=1.5)
    """plt.plot(gradi, final_yaw_NN_2 / final_vx_NN_2, label=name_NN_2, marker='x', linestyle='None', color=color_dict['Saffron_pastel'],
             markersize=15, markeredgewidth=2.0, linewidth=1.5)
    plt.plot(gradi, final_yaw_NN_3 / final_vx_NN_3, label=name_NN_3, marker='+', linestyle='None', color=color_dict['Green_pastel'],
             markersize=15, markeredgewidth=2.0, linewidth=1.5)"""
    # per far vedere che mu=1 è errato, usa riga sotto
    ...
    if 'highspeed' in speed:
        plt.savefig(savepath + '/step_steering'
                    '/steer_yaw_fx100_norm_relation.' + save_format, format=save_format, dpi=300)
    elif 'lowspeed' in speed:
        plt.savefig(savepath + '/step_steering'
                    '/steer_yaw_fx25_norm_relation.' + save_format, format=save_format, dpi=300)
    plt.close()
    ...
    metrics_nn_3 = calculate_metrics(final_yaw_NN_3, final_yaw_labels)
    ...
    metrics_nn_values_3 = list(metrics_nn_3.values())
    ...
    plt.bar(x, metrics_bicycle_values, width, label=name_bike, color=color_dict['Saffron_pastel'])
    plt.bar(x + width, metrics_bicycle_vx_comp_values, width, label=name_bike_vx_comp,
            color=color_dict['Green_pastel'])
    # per far vedere che mu=1 è errato, usa riga sotto
