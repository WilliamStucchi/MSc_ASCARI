...
for idx, value in enumerate(step_steering):
    ...
    ax1.plot(time_values, yaw_result_bicycle_vx_comp[:2000], color='orange', label='Bicycle model with Fx as input',  linewidth=2.5)
    ...
    final_vx_NN[idx] = results_NN[-1, 2]
    final_vx_bicycle[idx] = results_bicycle[-1, 5]
    final_vx_bicycle_vx_comp[idx] = results_bicycle_vx[-1, 5]
    final_vx_labels[idx] = vx_label[-1, 0]
...
gradi = [0, 1, 2, 3, 4, 5, 10, 15, 20, 25, 30, 45, 60, 75, 90]
...
plt.plot(gradi, final_yaw_bicycle, label='Bicycle model', marker='o', linestyle='None', color='g', linewidth=1.5)
plt.plot(gradi, final_yaw_bicycle_vx_comp, label='Bicycle model with Fx as input', marker='o', linestyle='None', color='orange', linewidth=1.5)
plt.plot(gradi, final_yaw_labels, label='Ground Truth', marker='o', linestyle='None', color='b', linewidth=1.5)
plt.xticks(gradi)
...
plt.plot(gradi, final_yaw_NN / final_vx_NN, label='NN model', marker='x', linestyle='None', color='r', linewidth=1.5)
plt.plot(gradi, final_yaw_bicycle / final_vx_bicycle, label='Bicycle model', marker='o', linestyle='None', color='g', linewidth=1.5)
plt.plot(gradi, final_yaw_bicycle_vx_comp / final_vx_bicycle_vx_comp, label='Bicycle model with Fx as input', marker='o', linestyle='None', color='orange', linewidth=1.5)
plt.plot(gradi, final_yaw_labels / final_vx_labels, label='Ground Truth', marker='o', linestyle='None', color='b', linewidth=1.5)
plt.xticks(gradi)
...
# Display the plot
plt.grid(True)
plt.savefig('../test/steering_equilibrium/step_steering/steer_yaw_norm_relation.png', format='png', dpi=300)
plt.close()
