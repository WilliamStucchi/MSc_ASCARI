...
def save_histogram(nn_mse, bike_mse, bikeFx_mse, nn_mae, bike_mae, bikeFx_mae, titels, value, savename):
...
path_to_plots = '../test/NN_vs_bicycle/paths_combined_perf_grip_bicycle/'
