...
def manage_paths() -> dict:
    ...
    path_dict['path2inputs_trainingdata_CRT'] = os.path.join(path_dict['path2inputs_trainingdata'], 'new')
    ...
    path_dict['filepath2inputs_testdata_CRT_temp'] = os.path.join(path_dict['path2inputs_trainingdata'], 'new')
    path_dict['filepath2inputs_testdata_CRT'] = os.path.join(path_dict['filepath2inputs_testdata_CRT_temp'], 'test_set')
