...
def create_dataset_separation_run_for_testing(data_test: np.array,
                                           params_dict: dict,
                                           nn_mode: str) -> tuple:
    """Creates a dataset to test the neural network against actual vehicle data.
    ...
    initials = data_test[0:input_timesteps, :]
    ...
    # get vehicle input data of test data file
    steeringangle_rad = data_test[input_timesteps:, output_shape]

    torqueRL_Nm = data_test[input_timesteps:, output_shape + 1]
    torqueRR_Nm = data_test[input_timesteps:, output_shape + 2]

    brakepresF_bar = data_test[input_timesteps:, output_shape + 3]
    brakepresR_bar = data_test[input_timesteps:, output_shape + 4]
...
def create_dataset_separation(path_dict: dict,
    ...
    filepath = path_dict['path2inputs_trainingdata_CRT']
