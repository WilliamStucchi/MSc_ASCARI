...
data = np.load("data/gen/exp_1_mod.npz")
...
NN_1 = NN_Model_mod(Param, nn_inputs, nn_labels)
...
with tf.device('/GPU:0'):
    with tf.Session() as sess:
        ...
        np.savez("results/gen_test_3_w/exp_1_mod",
        ...
        saver.save(sess, "saved_models/gen_test_3_w/exp_1_mod/model.ckpt")
...
# first Load in the data
data = np.load("data/gen/exp_2_mod.npz")
...
NN_2 = NN_Model_mod(Param, nn_inputs, nn_labels)
...
with tf.device('/GPU:0'):
    with tf.Session() as sess:
        ...
        # write out Experimental Results
        np.savez("results/gen_test_3_w/exp_2_mod",
                 test_mse=(test_mse_b, test_mse_nn),
                 delay_states=Param["T_MODEL"],
                 train_cost=train_cost,
                 dev_cost=dev_cost)
        ...
        # And save the session!
        saver.save(sess, "saved_models/gen_test_3_w/exp_2_mod/model.ckpt")
...
# first Load in the data
data = np.load("data/gen/exp_3_mod.npz")
...
NN_3 = NN_Model_mod(Param, nn_inputs, nn_labels)
...
with tf.device('/GPU:0'):
    with tf.Session() as sess:
        ...
        # write out Experimental Results
        np.savez("results/gen_test_3_w/exp_3_mod",
                 test_mse=(test_mse_b, test_mse_nn),
                 delay_states=Param["T_MODEL"],
                 train_cost=train_cost,
                 dev_cost=dev_cost)
        ...
        # And save the session!
        saver.save(sess, "saved_models/gen_test_3_w/exp_3_mod/model.ckpt")
...
# first Load in the data
data = np.load("data/gen/exp_5_mod.npz")
...
NN_5 = NN_Model_mod(Param, nn_inputs, nn_labels)
...
with tf.device('/GPU:0'):
    with tf.Session() as sess:
        ...
        # write out Experimental Results
        np.savez("results/gen_test_3_w/exp_5_mod",
                 test_mse=(test_mse_b, test_mse_nn),
                 delay_states=Param["T_MODEL"],
                 train_cost=train_cost,
                 dev_cost=dev_cost)
        ...
        # And save the session!
        saver.save(sess, "saved_models/gen_test_3_w/exp_5_mod/model.ckpt")
